...
static lv_color_t color_for_adv_type(uint8_t adv_type) {
    switch (adv_type) {
        ...
        case ADV_TYPE_REPEATER:  return lv_color_make(110,  60, 180); // dark purple
        case ADV_TYPE_ROOM:      return lv_color_make( 90, 200, 200); // cyan-teal
